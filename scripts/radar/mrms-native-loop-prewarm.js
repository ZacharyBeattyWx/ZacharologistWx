(() => {
  ...
  // v20 owns the one-time full native preload. v21 turns the overview into a
  // virtual timeline clock at deep zoom so only native radar is downloaded and
  // rendered during desktop native playback.
  load("scripts/radar/mrms-native-full-loop-v20.js?v=20260920b");
  load("scripts/radar/mrms-native-only-v21.js?v=20260920a");
